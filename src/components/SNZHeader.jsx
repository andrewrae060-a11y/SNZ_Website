            ...
            >
              {menuContent[activeMenu].map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className={`group flex h-full flex-col rounded-2xl border border-white/10 bg-white/5 text-left transition hover:-translate-y-1 hover:border-teal-300/40 hover:bg-white/10 ${
                      activeMenu === "Industries"
                        ? "p-4"
                        : "p-5"
                    }`}
                  ...
                  {activeMenu === "Solutions" &&
                    ...
                    <button
                      ...
                      className={`mt-auto inline-flex items-center pt-4 font-black text-teal-300 ${
                        activeMenu === "Industries"
                          ? "text-xs"
                          : "text-sm"
                      }`}
