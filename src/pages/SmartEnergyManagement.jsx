            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  ...
                  className="hidden items-center rounded-2xl border border-white/25 bg-white/5 px-7 py-4 text-sm font-black text-white backdrop-blur transition hover:bg-white/10"
                >
